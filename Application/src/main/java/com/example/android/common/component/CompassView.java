package com.example.android.common.component;
...
public class CompassView extends View {
    ...
    public float mCanvasRotateX = 0;
    public float mCanvasRotateY = 0;
...
//    }
    ...
    public double rotateCanvasWhenMove(float x, float y) {
        float dx = x - mCenterX;
        float dy = y - mCenterY;
